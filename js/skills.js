...
function initSkills(){
	h.globalSkills = [
	    ...
	    createSkill("Heal", "Heal between 10 - 20 + your level in HP", 3, Heal, 0, 100, 1),
	    createSkill("Duck Kick", "A more powerful but less accurate basic attack.", 1, genericSkill, 8, 85, 2),
	    ...
	    createSkill("Sword\nAttack", "A basic sword swing.", 2, genericSkill, 10, 90, 4),
